document.addEventListener('DOMContentLoaded', function() {
  ...
  legend.onAdd = function(map) {
    ...
    // reference for color map, change when implementing new func
  ...
  fetch('california-counties.geojson') // load counties + interactivity
    ...
    .then(data => {
      ...
      function onCountyClick(e) { // handles county clicks
        ...
        // display county information (CHANGE HERE)
        ...
        Object.entries(props).forEach(([key, value]) => { // FLASK STUFF DONE HERE
      ...
      // toggle filters done here, based on selection
